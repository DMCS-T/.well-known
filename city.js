...
var lifeTime = 12000; //> config
var lifeTime_branch = 12000; //> config
var prop_city2land = 5.0; //> config
var prop_land2city = 0.005;
var prop_branchOff = 15; //> config
var prop_branchOff_land = 6; //> config
var prop_branchOff_tomain = 15;
var branch_fallOff = 250;
var change_hue_newMain = 9;
var start_branches = wallpaper.configuration.start_branches; // 3
var max_steps_back = 500; //> config
